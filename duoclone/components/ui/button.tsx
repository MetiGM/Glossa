    ...
    variants: {
      variant: {
        default:
          ...
          primary: "bg-sky-400 text-primary-foreground hover:bg-sky-400/90 border-sky-500 border-b-4 active:border ",
          primaryOutline: "bg-white text-sky-500 hover:bg-slate-100",
          secondary: "bg-green-500 text-primary-foreground hover:bg-green-500/90 border-green-600 border-b-4 active:border ",
          secondaryOutline: "bg-white text-green-500 hover:bg-slate-100",
          danger:"bg-red-500 text-primary-foreground hover:bg-red-500/90 border-red-600 border-b-4 active:border ",
          dangerOutline:"bg-white text-red-500 hover:bg-slate-100",
          super:"bg-indigo-500 text-primary-foreground hover:bg-indigo-500/90 border-indigo-600 border-b-4 active:border ",
          ...
          sidebarOutline: "bg-sky-500/15 text-sky-500 border-sky-500 border-sky-300 border-2 hover:bg-sky-500/20 transition-none",
      },
      size: {
